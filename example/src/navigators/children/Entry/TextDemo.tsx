...
// import { createLayout, useStyle } from '../../src';
// import { useStyle, createLayout } from 'react-native-yoga-jsi';
import { useStyle, createLayout, Direction } from '../../../../../src';
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: 'green' }}>
      ...
      <Button
        title={'Set 1'}
        onPress={() => {
          width.value = withTiming(width.value / 2);
        }}
      />
      <Button
        title={'Set 2'}
